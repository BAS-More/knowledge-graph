...
import { NODE_TABLES, REL_TYPES } from 'knowledge-graph-shared';
...
//
// Source locations:
//   validLabel / validRelType  -- knowledge-graph-web/src/core/llm/tools.ts
//   isSafeId                   -- knowledge-graph-web/src/components/ProcessesPanel.tsx
//   readOnly guard (regex)     -- knowledge-graph-web/src/core/lbug/lbug-adapter.ts
// ---------------------------------------------------------------------------
