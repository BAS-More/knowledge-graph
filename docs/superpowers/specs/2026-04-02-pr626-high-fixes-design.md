...
**Date:** 2026-04-02
**PR:** BAS-More/knowledge-graph#626 — Intra-repo service communication tracking
...
**File:** `knowledge-graph/src/core/group/storage.ts`
...
**File:** `knowledge-graph/src/core/group/extractors/grpc-extractor.ts`
...
**File:** `knowledge-graph/src/core/group/service-boundary-detector.ts`
...
**Files:**
- `knowledge-graph/src/core/group/sync.ts` (lines 155-157) — per-id cleanup (KEEP)
- `knowledge-graph/src/cli/group.ts` (line 188) — blanket `closeLbug()` (REMOVE)
