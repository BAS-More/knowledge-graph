...
This roadmap describes the evolution of Knowledge-Graph's type-resolution layer from a receiver-disambiguation aid into a production-grade static-analysis foundation.
...
For Knowledge-Graph, production-grade does **not** mean replacing a language compiler. The target:
