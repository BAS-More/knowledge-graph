 ...
 *   - https://knowledge-graph.vercel.app     → allowed
...
describe('isAllowedOrigin: vercel.app', () => {
  it('allows https://knowledge-graph.vercel.app', () => {
    expect(isAllowedOrigin('https://knowledge-graph.vercel.app')).toBe(true);
  });
...
describe('isAllowedOrigin: rejected origins', () => {
  ...
  it('rejects https://knowledge-graph.example.com (not the official domain)', () => {
    expect(isAllowedOrigin('https://knowledge-graph.example.com')).toBe(false);
  });
