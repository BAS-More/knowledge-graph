...
// ============================================================================
// E2E: .gitignore + .knowledge-graphignore + unsupported language skip
// ============================================================================
...
describe('ignore + language-skip E2E', () => {
  ...
  beforeAll(async () => {
    ...
    // .knowledge-graphignore — excludes vendor/
  ...
  describe('file discovery (walkRepositoryPaths)', () => {
    ...
    it('excludes knowledge-graphignored directories (vendor/)', async () => {
      const files = await walkRepositoryPaths(tmpDir);
      const paths = files.map((f) => f.path.replace(/\\/g, '/'));
