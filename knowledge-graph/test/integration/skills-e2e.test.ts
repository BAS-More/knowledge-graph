 ...
 *
 * Tests `knowledge-graph analyze --skills` across 11 supported languages plus
...
function assertSkillFiles(
  ...
  expect(fs.existsSync(path.join(tmpDir, '.knowledge-graph'))).toBe(true);
