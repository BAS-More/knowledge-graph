...
describe('filesystem-walker', () => {
  ...
  describe('.knowledge-graphignore support', () => {
    ...
    beforeAll(async () => {
      ...
      // Only .knowledge-graphignore, no .gitignore
      await fs.writeFile(path.join(nexusignoreDir, '.knowledge-graphignore'), 'local/\n');
    });
    ...
    it('excludes directories listed in .knowledge-graphignore', async () => {
  ...
  describe('combined .gitignore + .knowledge-graphignore', () => {
    ...
    beforeAll(async () => {
      ...
      await fs.writeFile(path.join(combinedDir, '.knowledge-graphignore'), 'local/\n');
    });
  ...
  describe('KNOWLEDGE_GRAPH_NO_GITIGNORE env var', () => {
    let envDir: string;
    ...
    it('includes gitignored directory when KNOWLEDGE_GRAPH_NO_GITIGNORE is set', async () => {
