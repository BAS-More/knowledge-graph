 ...
 *
 * 1. Add the variant to the `NodeLabel` union in `knowledge-graph-shared/src/graph/types.ts`.
...
import type { NodeLabel } from 'knowledge-graph-shared';
 ...
 *
 * Adding a new NodeLabel to `knowledge-graph-shared`: TypeScript will flag this
