// knowledge-graph/src/core/ingestion/method-types.ts

import type { SupportedLanguages } from 'knowledge-graph-shared';
...
export interface MethodExtractor {
  ...
  extractFunctionName?(
    node: SyntaxNode,
  ): { funcName: string | null; label: import('knowledge-graph-shared').NodeLabel } | null;
}
