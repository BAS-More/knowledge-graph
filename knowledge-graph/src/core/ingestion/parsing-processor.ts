import type { GraphNode, GraphRelationship, NodeLabel } from 'knowledge-graph-shared';
...
import { getLanguageFromFilename, SupportedLanguages } from 'knowledge-graph-shared';
