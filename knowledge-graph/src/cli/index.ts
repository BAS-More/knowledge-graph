...
program
  ...
  .addHelpText(
    'after',
    '\nEnvironment variables:\n  KNOWLEDGE_GRAPH_NO_GITIGNORE=1  Skip .gitignore parsing (still reads .knowledge-graphignore)',
  )
...
program
  .command('index [path...]')
  .description(
    'Register an existing .knowledge-graph/ folder into the global registry (no re-analysis needed)',
  )
...
program
  .command('clean')
  .description('Delete Knowledge-Graph index for current repo')
